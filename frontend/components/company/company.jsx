    ...
    return <div className="company-item">
        ...
        <div className="company-detail">
          <div className="company-info">
            <Button variant="outlined" color="primary" className={this.props.button} id="something-button">
              Something
            </Button>
            <Button variant="outlined" color="primary" className={this.props.button} id="something-button">
              Something
          ...
          <div className="company-chart">
            <img src="https://pivotts.com/wp-content/uploads/2015/02/stock-chart-300x226.png" alt="" />
          </div>
          <br />
          <div>
            <Button variant="outlined" color="secondary" className={this.props.button} id="quarter-button">
